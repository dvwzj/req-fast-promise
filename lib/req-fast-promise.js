  ...
  request(method, url) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (options.params && _lodash.default.size(_lodash.default.keys(options.params))) {
        ...
        options.url = "".concat(uri.protocol, "//").concat(uri.hostname).concat(uri.port ? ":".concat(uri.port) : '').concat(uri.pathname ? uri.pathname : '', "?").concat(_qs.default.stringify(params));
      }
